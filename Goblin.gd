...
# At the top of your script, outside of any functions
...
func _ready():
	...
	# Initialize the health bar values here, inside the _ready() function
	health_bar.max_value = 100  # The maximum value of the health bar
	health_bar.value = health * 50  # Initial value, since each life represents 50% of the health bar
